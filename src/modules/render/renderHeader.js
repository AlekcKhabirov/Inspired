export const renderHeader = ()=>{
    ...
    header.innerHTML=`
    <div class="container header__container"><a href="tel:+79304902620" class="header__phone header__link">8 930 490 26 20</a>
    ...
    <ul class="header__nav-list">
        ...
        <li class="header__nav-item">
        <a class="header__link"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" xmlns="http://www.w3.org/2000/svg">
