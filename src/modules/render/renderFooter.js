export const renderFooter = () =>{
    ...
    <ul class="footer-category__list">
        ...
        <h3 class="footer-category__subtitle"><a class="footer__link" href="#">Женщины</h3>
        ...
        <h3 class="footer-category__subtitle"><a class="footer__link" href="#">Мужчины</h3>
            <ul class="footer-category__sublist">
            <li class="footer-category__subitem">
            <a class="footer__link" href="#">Трусы</a>
            </li>
    ...
    <h2 class="footer__title footer-social_title">Связаться с нами</h2>
    ...
    <a class="footer__link" href="tel:+79304902620">8 930 490 26 20</a>
    </div>
    ...
    <ul class="footer-development__list">
        <li class="footer-development__item">Designer:<a class="footer__link" href="#"> Anastasia Ilina</a>
        </li>
        <li class="footer-development__item">Developer: <a class="footer__link" href="#" onclick="alert('Piece')"> Алик</a>
        </li>
    </ul>  
    </div>
</div>
